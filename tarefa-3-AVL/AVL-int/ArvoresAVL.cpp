...
class Arvore
{
    ...
    void Balancear(void){
        ...
        */
        ...
        No *nosPtr[qNos];
        int nosChaves[qNos];
        getVetorAvr(raiz, nosChaves, nosPtr,q); //criar um vetor com a arvore, com raiz = raiz -> getVetorAvr()
        ...
        while(true){
            ...
            for(i = 0; i<qNos; i++){
                ...
                if(abs(FB) == 2){
                    ...
                    // cout << "no desbalanceado = " << noDesbalanceado << endl;
                }
            }          
...
int main(int argc, char *argv[])
{
    ...
    arv.inserir(50); arv.inserir(40); arv.inserir(60);arv.inserir(55);arv.inserir(70);arv.remover(100);
